...
//		// Monedero
//		if ($campo === 'monedero') {
//			$valorActual = $usuario->getMonedero();
//			$valor += $valorActual;
//		}
//
...
//	}
	...
	public function actualizarUsuario($data) {
		...
		if (isset($_FILES['foto']) && $_FILES['foto']['error'] === UPLOAD_ERR_OK) {
			...
			if ($actualizacionExitosa) {
				// Obtener el usuario actualizado desde el repositorio usando findByEmail
				$usuarioActualizado = $usuarioRepositorio->findByEmail($usuario->getEmail()); // Llamamos a findByEmail y pasamos el email del usuario

				// Actualizar la sesión con los nuevos datos
				Logger::actualizarSesion($usuarioActualizado);
